      ...
      _export("Plate", Plate = (_dec = ccclass('Plate'), _dec2 = property({
        ...
        initPos() {
          for (var i = 0; i < this.blackpos.length; i++) {
            for (var j = 1; j < this.blackpos[i].length; j++) {
              ...
              this.allpos.set(this.blackpos[i][j], (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
              }), Utils) : Utils).blackchs[this.blackpos[i][0]]);
              this.allpos.set(this.redpos[i][j], (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
                error: Error()
              }), Utils) : Utils).redchs[this.redpos[i][0]]);
            }
          }

          (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).xChessPos = [];

          for (var _i = 0; _i < this.xPlusPot.length; _i++) {
            (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).xChessPos.push(this.xPlusPot[_i]);
          }

          for (var _i2 = 0; _i2 < this.xPlusPot.length; _i2++) {
            (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).xChessPos.push(this.xPoints.length - this.xPlusPot[_i2] - 1);
          }
        }
        ...
        start() {
          ...
          (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            this.allpos.forEach((img, key) => {
              ...
              rtc.lineHeight = 100;
              rtc.fontSize = 100;
              rtc.node.active = true; // let sprite=n.getComponentInChildren(SpriteComponent);
        ...
        draw() {
          ...
          for (var _i5 = 0; _i5 < col + 1; _i5++) {
            var leftx = pts[0].x + _i5 * width + width / 2 + edge;
          ...
          for (var _i6 = 0; _i6 < row + 1; _i6++) {
            ...
            this.grap.lineTo(_leftx + s.width - border * 2 - width - edge * 2, _lefty + height * _i6);
          }
        ...
        unicodeTest() {
          var v = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
          }), Utils) : Utils).hex2Num('$1FA60');
...
//# sourceMappingURL=684ec2370a8253ace380a1c2cfc31c2951fb7ef3.js.map