        ...
        parsePolygons(s) {
          ...
          for (var i = 0; i < s.length; i++) {
            ...
            while (j < pts.length) {
              ...
              if (p.act == "M") {
                var v = new Vec2(Number.parseFloat(pts[j]), Number.parseFloat(pts[j + 1]));
                last = v;
                polygon.poly.push(v);
                p.pt = v;
                j = j + 2;
              } else if (p.act == "H") {
                var _v = new Vec2(Number.parseFloat(pts[j]), last.y);
                ...
                var _v2 = new Vec2(last.x, Number.parseFloat(pts[j]));
                ...
                var _v3 = new Vec2(Number.parseFloat(pts[j]), Number.parseFloat(pts[j + 1]));
                ...
                var _v4 = new Vec2(Number.parseFloat(pts[j]), Number.parseFloat(pts[j + 1]));
                ...
                var _v5 = new Vec2(Number.parseFloat(pts[j]), last.y);
                ...
                var _v6 = new Vec2(last.x, Number.parseFloat(pts[j]));
                ...
                var _v7 = new Vec2(Number.parseFloat(pts[j]), Number.parseFloat(pts[j + 1]));
...
//# sourceMappingURL=366a589334c2a69fe726d776794723b60fc59f1b.js.map