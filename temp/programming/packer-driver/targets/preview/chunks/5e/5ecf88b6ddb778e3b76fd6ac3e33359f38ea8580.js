        ...
        draw() {
          ...
          for (var i = 0; i < row + 1; i++) {
            for (var j = 0; j < col + 1; j++) {
              this.xPoints.push(new Vec3(border - edge / 2 + width * (j + 0.5) - s.width / 2, border - edge / 2 + height * (i + 0.5) - s.height / 2, 0));
            }
          }
...
//# sourceMappingURL=5ecf88b6ddb778e3b76fd6ac3e33359f38ea8580.js.map