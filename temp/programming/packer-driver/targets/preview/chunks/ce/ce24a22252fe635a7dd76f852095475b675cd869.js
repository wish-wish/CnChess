System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Vec2, UITransform, view, Polygon, Pot, _dec, _class, _crd, ccclass, property, Head;
          ...
          for (var i = 0; i < s.length; i++) {
            ...
            while (j < pts.length) {
              ...
              if (p.act == "M") {
                ...
                var _v4 = new Vec2(last.x + Number.parseFloat(xy[0]), last.y + Number.parseFloat(xy[1]));
...
//# sourceMappingURL=ce24a22252fe635a7dd76f852095475b675cd869.js.map