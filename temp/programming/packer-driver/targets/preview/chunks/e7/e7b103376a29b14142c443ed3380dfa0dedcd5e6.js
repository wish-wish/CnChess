      ...
      _export("Plate", Plate = (_dec = ccclass('Plate'), _dec2 = property({
        ...
        draw() {
          ...
          for (var _i3 = 0; _i3 < pts.length; _i3++) {
            this.grap.lineTo(pts[_i3].x, pts[_i3].y);
          }

          for (var _i4 = 0; _i4 < col + 1; _i4++) {
            var leftx = pts[0].x + _i4 * width + edge;
            var lefty = pts[0].y + edge;
          ...
          for (var _i5 = 0; _i5 < row + 1; _i5++) {
            var _leftx = pts[0].x + edge;

            var _lefty = pts[0].y + edge;

            this.grap.moveTo(_leftx, _lefty + height * _i5);
            this.grap.lineTo(_leftx + s.width - border * 2 - width, _lefty + height * _i5);
          }

          this.grap.moveTo(this.xPoints[this.XRoad[0]].x, this.xPoints[this.XRoad[0]].y);

          for (var _i6 = 1; _i6 < this.XRoad.length; _i6++) {
            var idx = this.XRoad[_i6];
          ...
          for (var _i7 = 1; _i7 < this.XRoad.length; _i7++) {
            var _idx = this.xPoints.length - this.XRoad[_i7] - 1;
          ...
          for (var _i8 = 0; _i8 < this.xPlusPot.length; _i8++) {
            var p = this.xPoints[this.xPlusPot[_i8]];
            this.drawCorss(p.x, p.y);
            var p1 = this.xPoints[this.xPoints.length - this.xPlusPot[_i8] - 1];
...
//# sourceMappingURL=e7b103376a29b14142c443ed3380dfa0dedcd5e6.js.map