          ...
          for (var i = 0; i < s.length; i++) {
            ...
            while (j < pts.length) {
              ...
              if (p.act == "M") {
                ...
                //let v=new Vec2(last.x+Number.parseFloat(xy[0]),last.y+Number.parseFloat(xy[1]));
                var _v4 = new Vec2(Number.parseFloat(xy[0]), Number.parseFloat(xy[1]));
...
//# sourceMappingURL=c7aa0c95ce1e54d1cf11b273207231508761668c.js.map