        ...
        draw() {
          ...
          for (var i = 0; i < row + 1; i++) {
            for (var j = 0; j < col + 1; j++) {
              this.xPoints.push(new Vec3(border - edge + width * (j + 1) - s.width / 2, border - edge + height * (i + 1) - s.height / 2, 0));
            }
          }
...
//# sourceMappingURL=96ccad247a26d8387a133a026c433ddbcac757f3.js.map