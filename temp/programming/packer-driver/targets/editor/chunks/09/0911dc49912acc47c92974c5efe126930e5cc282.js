  ...
  return {
    ...
    execute: function () {
      ...
      _export("Utils", Utils = (_dec = ccclass('Utils'), _dec(_class = (_class2 = class Utils extends Component {
        ...
        static numInterval(cb, ms, times = -1) {
        ...
        static oneInterval(cb, ms) {
          let intval = this.numInterval(cb, ms, 1); // let intval=setInterval(()=>{
          //     clearInterval(intval);
          //     if(cb) cb();
          // });
        ...
        static randomColor() {
          ...
          let b = math.randomRangeInt(0, 256); //let a=math.randomRangeInt(0,256);

          return new Color(r, g, b);
        }

        static randomRed() {
          let color = new Color(math.randomRangeInt(0, 256), 0, 0);
          let reds = [Color.RED, Color.MAGENTA, color];
          return reds[math.randomRangeInt(0, reds.length)];
        }

        static randomGreen() {
          let color = new Color(0, math.randomRangeInt(0, 256), 0);
          let reds = [Color.GREEN, color];
          return reds[math.randomRangeInt(0, reds.length)];
        }

        static randomBlue() {
          let color = new Color(0, 0, math.randomRangeInt(0, 256));
          let reds = [Color.BLUE, color];
          return reds[math.randomRangeInt(0, reds.length)];
        }
      ...
      }, _class2.subjects = new Array(), _class2.curridx = 0, _class2.initeds = [false, false, false, false, false, false, false, false], _class2.prefabs = new Map(), _class2.intervals = [], _class2.intercounts = new Map(), _class2.uguid = "id_abc123", _class2.baseDict = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=', _class2._keyStr = "BCDEFHIJKLMNOQRSTUVWXYZbcdefhijklmnoqrstuvwxyz0123456789", _class2)) || _class));
...
//# sourceMappingURL=0911dc49912acc47c92974c5efe126930e5cc282.js.map