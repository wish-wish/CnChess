System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, Vec2, UITransform, view, Polygon, _dec, _class, _crd, ccclass, property, Head;
        ...
        parsePolygons(s) {
          ...
          for (let i = 0; i < s.length; i++) {
            ...
            for (let j = 1; j < pts.length; j++) {
              if (pts.length > 1) {
                polygon.poly.push(new Vec2(Number.parseFloat(pts[0]), Number.parseFloat(pts[1])));
              }
            }
...
//# sourceMappingURL=1ff79349310736f3da35a1e489be86a52792c10c.js.map