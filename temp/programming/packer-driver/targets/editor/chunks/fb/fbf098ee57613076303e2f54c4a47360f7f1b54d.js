          ...
          (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            ...
            for (let i = 0; i < ords.length; i++) {
              ...
              if (i > 8) {
                ...
                let pos = this.xPoints[idx].add(new Vec3(0, this.cells.height * 1.5, 0));
                n.setPosition(pos);
              } else {
                let pos = this.xPoints[idx].subtract(new Vec3(0, this.cells.height / 2, 0));
                n.setPosition(pos);
              }
            }
          });
...
//# sourceMappingURL=fbf098ee57613076303e2f54c4a47360f7f1b54d.js.map