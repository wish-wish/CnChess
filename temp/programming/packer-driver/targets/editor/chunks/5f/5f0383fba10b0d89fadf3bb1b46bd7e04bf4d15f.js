      ...
      _export("Plate", Plate = (_dec = ccclass('Plate'), _dec2 = property({
        ...
        initPos() {
          ...
          for (let i = 0; i < this.xPlusPot.length; i++) {
            (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).xChessPos.push(this.xPlusPot[i]);
          }

          for (let i = 0; i < this.xPlusPot.length; i++) {
            (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
              error: Error()
            }), Utils) : Utils).xChessPos.push(this.xPoints.length - this.xPlusPot[i] - 1);
          }
        }
        ...
        unicodeTest() {
          let v = (_crd && Utils === void 0 ? (_reportPossibleCrUseOfUtils({
            error: Error()
...
//# sourceMappingURL=5f0383fba10b0d89fadf3bb1b46bd7e04bf4d15f.js.map