        ...
        parsePolygons(s) {
          ...
          for (let i = 0; i < s.length; i++) {
            ...
            while (j < pts.length) {
              ...
              if (p.act == "M") {
                let v = new Vec2(Number.parseFloat(pts[j]), Number.parseFloat(pts[j + 1]));
                last = v;
                polygon.poly.push(v);
                p.pt = v;
                j = j + 2;
              } else if (p.act == "H") {
                let v = new Vec2(Number.parseFloat(pts[j]), last.y);
                last = v;
                polygon.poly.push(v);
                p.pt = v;
                j = j + 1;
              } else if (p.act == "V") {
                let v = new Vec2(last.x, Number.parseFloat(pts[j]));
                last = v;
                polygon.poly.push(v);
                p.pt = v;
                j = j + 1;
...
//# sourceMappingURL=f076573d660eb40e5b47ab81b5083746e9848707.js.map